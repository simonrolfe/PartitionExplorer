...
{
    public class MM3_128bit : IStringHasher<byte[]>
    {
        ...
        byte[] IStringHasher<byte[]>.Hash(string input)
        {
...
#if UNSAFE // TODO: this doesn't actually do anything, but eventually I'll set a flag in the build process
